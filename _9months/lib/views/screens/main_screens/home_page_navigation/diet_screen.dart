...
import 'package:myapp/providers/future_provider/diet_provider.dart';
import 'package:myapp/providers/future_provider/exercises_provider.dart';
import 'article_detail_screen.dart';

class DietArticlesPage extends ConsumerWidget {
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final Size size = MediaQuery.of(context).size; // Get screen size
    final articlesAsyncValue = ref.watch(dietArticlesProvider);
